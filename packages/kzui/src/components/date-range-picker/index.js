...
class DateRangePicker extends KZUIComponent {
    ...
    */
    ...
    render() {
        ...
        return (
            <div className={cls} style={style} onBlur={this.handleBlur} ref={this.storeRef('date_picker')}>
                <PopTip
                    isPopover
                    visible={expand}
                        ...
                        <React.Fragment>
                            ...
                            <div className={`${clsPrefix}-date-panels`}>
                                <DatePanel
                                    ...
                                    onPanelChange={
                                      (year, month) => this.handlePanel(year, month, 0)
                                    }
                                ...
                                <DatePanel
                                    ...
                                    onPanelChange={
                                      (year, month) => this.handlePanel(year, month, 1)
                                    }
                                    onCollapse={() => this.handleClick()}
                                    index={index2}
                                    pos={2}
